    ...
    public void onCreate(Bundle savedInstanceState) {
                    ...
                    db.collection("expense_forms")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Intent index = new Intent(com.example.gsbppe4vu.VisitorExpenseFormActivity.this, VisitorIndexActivity.class);
        ...
        btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.VisitorExpenseFormActivity.this, com.example.gsbppe4vu.MainActivity.class);
        ...
        btn_praticien.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent praticien = new Intent(com.example.gsbppe4vu.VisitorExpenseFormActivity.this, VisitorPractitionersActivity.class);
        ...
        btn_rdv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent rdv = new Intent(com.example.gsbppe4vu.VisitorExpenseFormActivity.this, VisitorCalendarActivity.class);
        ...
        btn_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.VisitorExpenseFormActivity.this, VisitorProfilActivity.class);
