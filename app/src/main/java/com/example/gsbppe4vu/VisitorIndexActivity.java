    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.VisitorIndexActivity.this, com.example.gsbppe4vu.MainActivity.class);
        ...
        btn_praticien.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent praticien = new Intent(com.example.gsbppe4vu.VisitorIndexActivity.this, VisitorPractitionersActivity.class);
        ...
        btn_rdv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent rdv = new Intent(com.example.gsbppe4vu.VisitorIndexActivity.this, com.example.gsbppe4vu.VisitorCalendarActivity.class);
        ...
        btn_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frais = new Intent(com.example.gsbppe4vu.VisitorIndexActivity.this, com.example.gsbppe4vu.VisitorExpenseFormActivity.class);
        ...
        btn_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.VisitorIndexActivity.this, VisitorProfilActivity.class);
