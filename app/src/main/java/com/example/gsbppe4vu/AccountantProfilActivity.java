    ...
    public void onCreate(Bundle savedInstanceState) {
                    ...
                    db.collection("users")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Toast.makeText(com.example.gsbppe4vu.AccountantProfilActivity.this, "Changement(s) effectué(s)",
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    Toast.makeText(com.example.gsbppe4vu.AccountantProfilActivity.this, "Il y a une erreur quelque part, veuillez réessayer.",
                                            Toast.LENGTH_SHORT).show();
                                }
                            });
                }
                                ...
                                userFB.updatePassword(new_password).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (!task.isSuccessful()){
                                            ...
                                            Toast.makeText(com.example.gsbppe4vu.AccountantProfilActivity.this, "Mot de passe mis à jour.",
                                                    Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
        ...
        btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.AccountantProfilActivity.this, com.example.gsbppe4vu.MainActivity.class);
        ...
        btn_val_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent val_frais = new Intent(com.example.gsbppe4vu.AccountantProfilActivity.this, AccountantListExpenseFormLeftActivity.class);
        ...
        btn_frais_mois.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frais_mois = new Intent(com.example.gsbppe4vu.AccountantProfilActivity.this, com.example.gsbppe4vu.AccountantBundleMontlyActivity.class);
