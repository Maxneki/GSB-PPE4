    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.VisitorCalendarAddRdvActivity.this, MainActivity.class);
        ...
        this.btn_rdv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent rdv = new Intent(com.example.gsbppe4vu.VisitorCalendarAddRdvActivity.this, VisitorCalendarActivity.class);
        ...
        this.btn_praticien.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent praticien = new Intent(com.example.gsbppe4vu.VisitorCalendarAddRdvActivity.this, VisitorPractitionersActivity.class);
        ...
        this.btn_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frais = new Intent(com.example.gsbppe4vu.VisitorCalendarAddRdvActivity.this, VisitorExpenseFormActivity.class);
        ...
        this.btn_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.VisitorCalendarAddRdvActivity.this, VisitorProfilActivity.class);
        ...
        db.collection("practitioners").get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    adapter = new ArrayAdapter<String>(com.example.gsbppe4vu.VisitorCalendarAddRdvActivity.this, android.R.layout.simple_spinner_dropdown_item, practitioners);
        ...
        btnAddRdv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (etDate.getText().length() == 0 || etTime.getText().length() == 0) {
                    ...
                    Toast.makeText(com.example.gsbppe4vu.VisitorCalendarAddRdvActivity.this, "Au moins un des champs est vide",
                    ...
                    db.collection("agenda").document(GenerateRandomString.randomString(20)).set(agendaMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                        ...
                        public void onSuccess(Void aVoid) {
                            ...
                            Intent calendar = new Intent(com.example.gsbppe4vu.VisitorCalendarAddRdvActivity.this, VisitorCalendarActivity.class);
