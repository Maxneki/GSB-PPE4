        ...
        this.btn_login.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (edt_email.getText().length()==0 || edt_password.getText().length()==0){
                    ...
                    Toast.makeText(com.example.gsbppe4vu.MainActivity.this, "\"Email et/ou mot de passe incorrect(s).\"",
                            Toast.LENGTH_SHORT).show();
                }
                else {

                    mAuth.signInWithEmailAndPassword(edt_email.getText().toString(), edt_password.getText().toString())
                            .addOnCompleteListener(com.example.gsbppe4vu.MainActivity.this, new OnCompleteListener<AuthResult>() {
                                                ...
                                                if (task.isSuccessful()) {
                                                    ...
                                                    if (document.exists()) {
                                                        ...
                                                        if (userFC.getRole().equals("visitor")) {
                                                            Intent iVisitor = new Intent(com.example.gsbppe4vu.MainActivity.this, VisitorIndexActivity.class);
                                                        ...
                                                        //envoi vers le menu comptable avec les infos comptable
                                                            ...
                                                            Intent iAccountant = new Intent(com.example.gsbppe4vu.MainActivity.this, AccountantIndexActivity.class);
