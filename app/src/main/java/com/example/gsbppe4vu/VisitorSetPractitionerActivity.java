    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            adapter = new ArrayAdapter<String>(com.example.gsbppe4vu.VisitorSetPractitionerActivity.this, android.R.layout.simple_spinner_dropdown_item, workplaces); // simple_spinner_dropdown_item existe de base
                        ...
                        if (i_recu.hasExtra("practitionerInfo")){
                            ...
                            currentPractitioner.setId(com.example.gsbppe4vu.GenerateRandomString.randomString(20));
                        }
                    }
                });
        ...
        btn_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (et_name.getText().length()==0 || et_firstName.getText().length()==0 || et_coeffReputation.getText().length()==0 ||
                    ...
                    Toast.makeText(com.example.gsbppe4vu.VisitorSetPractitionerActivity.this, "Au moins un champs est vide",
                    ...
                    db.collection("practitioners")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Intent praticien = new Intent(com.example.gsbppe4vu.VisitorSetPractitionerActivity.this, VisitorPractitionersActivity.class);
        ...
        btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.VisitorSetPractitionerActivity.this, com.example.gsbppe4vu.MainActivity.class);
        ...
        btn_rdv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent rdv = new Intent(com.example.gsbppe4vu.VisitorSetPractitionerActivity.this, com.example.gsbppe4vu.VisitorCalendarActivity.class);
        ...
        btn_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frais = new Intent(com.example.gsbppe4vu.VisitorSetPractitionerActivity.this, com.example.gsbppe4vu.VisitorExpenseFormActivity.class);
        ...
        btn_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.VisitorSetPractitionerActivity.this, VisitorProfilActivity.class);
