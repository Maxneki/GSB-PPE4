...
public class ExpenseFormAdapter extends BaseAdapter {
    ...
    private List<com.example.gsbppe4vu.ExpenseForm> datas;

    public ExpenseFormAdapter(Context content, List<com.example.gsbppe4vu.ExpenseForm> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.gsbppe4vu.ExpenseForm current = (com.example.gsbppe4vu.ExpenseForm) getItem(position);
