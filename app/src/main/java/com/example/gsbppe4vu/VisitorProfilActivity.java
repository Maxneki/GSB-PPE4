    ...
    public void onCreate(Bundle savedInstanceState) {
                    ...
                    db.collection("users")
                            ...
                            .addOnSuccessListener(new OnSuccessListener<Void>() {
                                ...
                                public void onSuccess(Void aVoid) {
                                    ...
                                    Toast.makeText(com.example.gsbppe4vu.VisitorProfilActivity.this, "Changement(s) effectué(s)",
                            ...
                            .addOnFailureListener(new OnFailureListener() {
                                ...
                                public void onFailure(@NonNull Exception e) {
                                    ...
                                    Toast.makeText(com.example.gsbppe4vu.VisitorProfilActivity.this, "Il y a une erreur quelque part, veuillez réessayer.",
                                            Toast.LENGTH_SHORT).show();
                                }
                            });
                }
                                ...
                                userFB.updatePassword(new_password).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (!task.isSuccessful()){
                                            ...
                                            Toast.makeText(com.example.gsbppe4vu.VisitorProfilActivity.this, "Mot de passe mis à jour.",
                                                    Toast.LENGTH_SHORT).show();
                                        }
                                    }
                                });
        ...
        btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.VisitorProfilActivity.this, com.example.gsbppe4vu.MainActivity.class);
        ...
        btn_praticien.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent praticien = new Intent(com.example.gsbppe4vu.VisitorProfilActivity.this, VisitorPractitionersActivity.class);
        ...
        btn_rdv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent rdv = new Intent(com.example.gsbppe4vu.VisitorProfilActivity.this, com.example.gsbppe4vu.VisitorCalendarActivity.class);
        ...
        btn_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frais = new Intent(com.example.gsbppe4vu.VisitorProfilActivity.this, com.example.gsbppe4vu.VisitorExpenseFormActivity.class);
