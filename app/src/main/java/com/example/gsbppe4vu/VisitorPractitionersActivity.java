...
public class VisitorPractitionersActivity extends AppCompatActivity {
    ...
    private List<com.example.gsbppe4vu.Practitioner> practitionerList;
    ...
    public void onCreate(Bundle savedInstanceState) {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                practitionerList.add(new com.example.gsbppe4vu.Practitioner(document));
                                //Log.d("testPendant", practitionerList.size()+""); // taille de la liste
                            }
                            // ajoute la liste des praticiens dans la listview
                            com.example.gsbppe4vu.PractitionerAdapter pracAdap = new com.example.gsbppe4vu.PractitionerAdapter(com.example.gsbppe4vu.VisitorPractitionersActivity.this, practitionerList);
        ...
        lv_practitioners.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                com.example.gsbppe4vu.Practitioner current = (com.example.gsbppe4vu.Practitioner) parent.getAdapter().getItem(position);
                Intent practitionInfo = new Intent(com.example.gsbppe4vu.VisitorPractitionersActivity.this, com.example.gsbppe4vu.VisitorPractitionerInfoActivity.class);
        ...
        btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.VisitorPractitionersActivity.this, com.example.gsbppe4vu.MainActivity.class);
        ...
        btn_rdv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent rdv = new Intent(com.example.gsbppe4vu.VisitorPractitionersActivity.this, com.example.gsbppe4vu.VisitorCalendarActivity.class);
        ...
        btn_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frais = new Intent(com.example.gsbppe4vu.VisitorPractitionersActivity.this, com.example.gsbppe4vu.VisitorExpenseFormActivity.class);
        ...
        btn_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.VisitorPractitionersActivity.this, com.example.gsbppe4vu.VisitorProfilActivity.class);
        ...
        btn_set_practitioner.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.VisitorPractitionersActivity.this, com.example.gsbppe4vu.VisitorSetPractitionerActivity.class);
                profil.putExtra("currentUser", currentUser);
                startActivity(profil);
            }
        });
