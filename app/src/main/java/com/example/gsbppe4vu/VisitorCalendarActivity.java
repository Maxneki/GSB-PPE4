    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.VisitorCalendarActivity.this, com.example.gsbppe4vu.MainActivity.class);
        ...
        this.btn_praticien.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent praticien = new Intent(com.example.gsbppe4vu.VisitorCalendarActivity.this, VisitorPractitionersActivity.class);
        ...
        this.btn_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frais = new Intent(com.example.gsbppe4vu.VisitorCalendarActivity.this, com.example.gsbppe4vu.VisitorExpenseFormActivity.class);
        ...
        this.btn_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.VisitorCalendarActivity.this, VisitorProfilActivity.class);
        ...
        this.btn_add_rdv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent add_rdv = new Intent(com.example.gsbppe4vu.VisitorCalendarActivity.this, com.example.gsbppe4vu.VisitorCalendarAddRdvActivity.class);
        ...
        this.btn_consult_rdv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent consult_agenda = new Intent(com.example.gsbppe4vu.VisitorCalendarActivity.this, com.example.gsbppe4vu.VisitorCalendarDateDetailActivity.class);
