    ...
    public void onCreate(Bundle savedInstanceState) {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            adapter = new ArrayAdapter<String>(com.example.gsbppe4vu.AccountantBundleMontlyActivity.this, android.R.layout.simple_spinner_dropdown_item, dateList); // simple_spinner_dropdown_item existe de base
        ...
        btn_validate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent bundleMontlyInfo = new Intent(com.example.gsbppe4vu.AccountantBundleMontlyActivity.this, AccountantBundleMontlyInfoActivity.class);
        ...
        btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.AccountantBundleMontlyActivity.this, MainActivity.class);
        ...
        btn_val_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent val_frais = new Intent(com.example.gsbppe4vu.AccountantBundleMontlyActivity.this, AccountantListExpenseFormLeftActivity.class);
        ...
        btn_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.AccountantBundleMontlyActivity.this, AccountantProfilActivity.class);
