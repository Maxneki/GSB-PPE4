...
public class AgendaAdapter extends BaseAdapter {
    ...
    private List<com.example.gsbppe4vu.Agenda> datas;

    public AgendaAdapter(Context content, List<com.example.gsbppe4vu.Agenda> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.gsbppe4vu.Agenda current = (com.example.gsbppe4vu.Agenda) getItem(position);
