...
public class PractitionerAdapter extends BaseAdapter {
    ...
    private List<com.example.gsbppe4vu.Practitioner> datas;

    public PractitionerAdapter(Context content, List<com.example.gsbppe4vu.Practitioner> datas) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        com.example.gsbppe4vu.Practitioner current = (com.example.gsbppe4vu.Practitioner) getItem(position);
