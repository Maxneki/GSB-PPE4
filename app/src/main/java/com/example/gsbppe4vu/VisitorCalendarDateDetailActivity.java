    ...
    public void onCreate(Bundle savedInstanceState) {
                ...
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            AgendaAdapter agenAdap = new AgendaAdapter(com.example.gsbppe4vu.VisitorCalendarDateDetailActivity.this, agendaList);
        ...
        this.lv_rdv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (current.getUserId().equals(currentUser.getId())){ // si le rdv appartient à l'utilisateur actuel
                    Intent agendaInfo = new Intent(com.example.gsbppe4vu.VisitorCalendarDateDetailActivity.this, VisitorAgendaInfoActivity.class);
                    agendaInfo.putExtra("currentUser", currentUser);
                    agendaInfo.putExtra("agendaInfo", (Serializable) current);
                    startActivity(agendaInfo);
                }
                else {
                    Toast.makeText(com.example.gsbppe4vu.VisitorCalendarDateDetailActivity.this, "Ce rendez-vous ne vous est pas assigné.",
        ...
        this.btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.VisitorCalendarDateDetailActivity.this, MainActivity.class);
        ...
        this.btn_rdv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent rdv = new Intent(com.example.gsbppe4vu.VisitorCalendarDateDetailActivity.this, VisitorCalendarActivity.class);
        ...
        this.btn_praticien.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent praticien = new Intent(com.example.gsbppe4vu.VisitorCalendarDateDetailActivity.this, VisitorPractitionersActivity.class);
        ...
        this.btn_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frais = new Intent(com.example.gsbppe4vu.VisitorCalendarDateDetailActivity.this, VisitorExpenseFormActivity.class);
        ...
        this.btn_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.VisitorCalendarDateDetailActivity.this, VisitorProfilActivity.class);
