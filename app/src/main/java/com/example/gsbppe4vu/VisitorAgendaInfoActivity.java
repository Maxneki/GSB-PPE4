...
public class VisitorAgendaInfoActivity extends AppCompatActivity {
    ...
    private com.example.gsbppe4vu.Agenda currentAgenda;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        currentAgenda = (com.example.gsbppe4vu.Agenda) i_recu.getSerializableExtra("agendaInfo");
                ...
                db.collection("agenda").document(currentAgenda.getId())
                        ...
                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                            ...
                            public void onSuccess(Void aVoid) {
                                ...
                                Intent rdv = new Intent(com.example.gsbppe4vu.VisitorAgendaInfoActivity.this, com.example.gsbppe4vu.VisitorCalendarActivity.class);
                                rdv.putExtra("currentUser", currentUser);
                                Toast.makeText(com.example.gsbppe4vu.VisitorAgendaInfoActivity.this, "Rendez-vous supprimé.",
        ...
        btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.VisitorAgendaInfoActivity.this, com.example.gsbppe4vu.MainActivity.class);
        ...
        btn_praticien.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent praticien = new Intent(com.example.gsbppe4vu.VisitorAgendaInfoActivity.this,  com.example.gsbppe4vu.VisitorPractitionersActivity.class);
        ...
        btn_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frais = new Intent(com.example.gsbppe4vu.VisitorAgendaInfoActivity.this, com.example.gsbppe4vu.VisitorExpenseFormActivity.class);
        ...
        btn_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.VisitorAgendaInfoActivity.this, com.example.gsbppe4vu.VisitorProfilActivity.class);
