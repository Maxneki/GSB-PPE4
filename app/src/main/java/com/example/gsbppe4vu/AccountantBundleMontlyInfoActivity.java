...
public class AccountantBundleMontlyInfoActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<com.example.gsbppe4vu.ExpenseForm> expenseFormList = new ArrayList<com.example.gsbppe4vu.ExpenseForm>();
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task){
                        if (task.isSuccessful()) {
                            for (QueryDocumentSnapshot document : task.getResult()) {
                                ...
                                com.example.gsbppe4vu.ExpenseForm currentExpenseForm = new com.example.gsbppe4vu.ExpenseForm(document);
        ...
        btn_dcnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent connexion = new Intent(com.example.gsbppe4vu.AccountantBundleMontlyInfoActivity.this, MainActivity.class);
        ...
        btn_val_frais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent val_frais = new Intent(com.example.gsbppe4vu.AccountantBundleMontlyInfoActivity.this, AccountantListExpenseFormLeftActivity.class);
        ...
        btn_frais_mois.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent frais_mois = new Intent(com.example.gsbppe4vu.AccountantBundleMontlyInfoActivity.this, com.example.gsbppe4vu.AccountantBundleMontlyActivity.class);
        ...
        btn_profil.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent profil = new Intent(com.example.gsbppe4vu.AccountantBundleMontlyInfoActivity.this, AccountantProfilActivity.class);
